...
@api_view(['POST'])
@permission_classes([AllowAny])  # Keep open during testing; restrict in production
    ...
    if serializer.is_valid():
        try:
            ...
            try:
                ...
                logger.warning(f"Category prediction failed: {cat_err}")
                predicted_category = "Unknown"

            # ✅ Save to MongoDB via Report model
